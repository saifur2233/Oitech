...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-200 text-base-content">
      ...
      <div>
        <span className="footer-title">Quick Page</span>
      ...
      <div>
        ...
        <Link className="link link-hover">shirapria@gmail.com</Link>
        <Link className="link link-hover">Auckland, New Zealand</Link>
        <Link className="link link-hover">+64 20 4166 1516</Link>
